      ...
      <div class="page-wrapper">
        ...
        <div class="page-body">
          <div class="container-xl">
              ...
              <div class="col-12">
                <form class="card" method="post" action="mahasiswa.php">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
						...
						$query = "select stambuk, nama from user ";
						...
						?> 
							<tr>
										...
										<button type="submit" name="delete" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')"><i class="mdi mdi-delete"></i>HAPUS</button>
