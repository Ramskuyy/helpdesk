              ...
              <div class="col-12">
                <form class="card" method="post" action="index.php" enctype="multipart/form-data">
                  <div class="card-header">
                    <h4 class="card-title">Validasi Pengaduan</h4>
                  </div>
                  <div class="card-body">
                    <div class="row">
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
						...
						$query = "SELECT * from laporan where laporan.status='Belum di Konfirmasi'";
						...
						?> 
							<tr>
									...
									Detail</button>	
									<input type="hidden" name="id" value="<?php echo $row['id'] ?>">
									<button class="btn btn-success" name="detail" type="button" data-bs-toggle="modal" data-bs-target="#edit<?php echo $row['id'] ?>">
									Edit</button>	
...
<div class="modal modal-blur fade" id="detail<?php echo $row['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div class="modal modal-blur fade" id="edit<?php echo $row['id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Pengaduan</h5>
          ...
          <div class="modal-body">
			...
			<label class="form-label">
              ...
              <div class="row">
              <textarea type="text" class="form-control" autocomplete="off" name="catatan"></textarea>     
              </div>
            </div>
			<div class="form-group">
              <div class="row">
          ...
          <div class="modal-footer">
		  <button class="btn btn-success" type="submit" name="ubah">Kirim</button>
            <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
