      ...
      <div class="page-wrapper">
        ...
        <div class="page-body">
          <div class="container-xl">
              ...
              <div class="col-12">
                <form class="card" method="post" action="rekap_pengaduan.php">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
						...
						$query = "SELECT MONTHNAME(tanggal) as bulan, YEAR(tanggal) as tahun from laporan group by bulan";
						...
						?> 
							<tr>
												...
												<form method="post" action="rekap_pengaduan.php">
												<input type="hidden" name="tahun" value="<?php echo $row['tahun'] ?>">
											<input type="hidden" name="bulan" value="<?php echo $row['bulan'] ?>">
										
									 <a href="./detail_rekap.php?bulan=<?php echo $row['bulan'] ?> & tahun=<?php echo $row['tahun'] ?>" class="btn btn-success">Lihat</a>
          ...
          <div class="modal-body">
           ...
           <div class="form-group">
			...
			<div class="form-group">
              ...
              <div class="col-sm-8"><?php echo $row['lokasii'] ?></div>
              </div>
            </div>
			<div class="form-group">
              <div class="row">
              <label class="col-sm-3 control-label text-right">Fasilitas<span class="text-red"></span></label> :
              <div class="col-sm-8"><?php echo $row['fasilitass'] ?></div>
              </div>
            </div>
			<div class="form-group">
              <div class="row">
